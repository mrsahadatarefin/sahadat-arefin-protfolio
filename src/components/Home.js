...
const Home = () => {
    return (
        <div name='home' className=' h-screen  bg-gradient-to-b from-black to-gray-800 via-black text-white '>
           <div data-aos="zoom-in" data-aos-duration="2000" className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row '>
            <div className='flex flex-col  justify-center h-full '>
                ...
                <div>
                    <Link to='projects' className=' group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to bg-blue-500 cursor-pointer'>Projects
